...
Which of the following protocols operates at the Transport layer and is responsible for flow control?
a) TCP
b) UDP
c) ICMP
d) IP
...
What does the term "encapsulation" refer to in the context of the OSI model?
...
Which layer of the OSI model uses the concept of segments, packets, frames, and bits?
a) Application layer
b) Transport layer
c) Network layer
d) Data Link layer
...
In TCP, what does a "three-way handshake" accomplish?
...
When a packet is sent from a host to a router, which layer's headers are used to determine the next hop?
a) Data Link layer
b) Network layer
c) Transport layer
d) Application layer
...
Which statement about IP addressing is correct?
...
In a network using NAT, what happens to the private IP addresses?
...
What type of address is used by the Data Link layer to communicate with devices on the same local network?
a) IP address
b) MAC address
c) Logical address
d) Port number
...
In which layer of the OSI model does the IP protocol operate?
a) Application
b) Transport
c) Network
d) Data Link
...
Which layer of the TCP/IP model corresponds to the OSI's Network layer?
a) Application layer
b) Transport layer
c) Internet layer
d) Link layer
...
What does the Transport layer in the OSI model do?
...
Which layer of the TCP/IP model handles the physical transmission of data?
a) Application
b) Transport
c) Internet
d) Link
...
In the OSI model, which layer provides services for network management?
a) Transport
b) Session
c) Network
d) Application
...
b) An address used to identify applications
c) A layer 3 address
d) A temporary address assigned by a DHCP server
Correct answer: A

What is the purpose of the ICMP protocol?
a) To manage the flow of data
...
Which layer of the OSI model would you look at to troubleshoot network connectivity issues?
a) Application
b) Network
c) Data Link
d) All of the above
...
Which protocol provides a reliable communication channel?
a) UDP
b) IP
c) TCP
d) ARP
...
Which layer of the TCP/IP model is equivalent to the OSI's Presentation layer?
a) Application
b) Internet
c) Transport
d) Link
...
What does a firewall primarily operate at?
a) Application layer
b) Network layer
c) Data Link layer
d) Transport layer
